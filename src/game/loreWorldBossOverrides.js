...
const POLICY_SPECS = Object.freeze([
  ...
  finalPolicy(
    "Spider-Man PS1",
    "spider-man-ps1-monster-ock-nexus-pursuit",
    "stageSetpiece",
    "Spider-Man (2000) - Monster-Ock laboratory escape",
    "Fuir Monster-Ock dans les tunnels en esquivant tentacules, flammes et effondrements jusqu'a la sortie.",
    "Escape Monster-Ock through the tunnels while avoiding tentacles, fire and collapses until the exit.",
    "La sequence canonique est une poursuite chronometree, pas un duel statique.",
    "The canonical sequence is a timed chase, not a static duel.",
    ["https://spiderman.fandom.com/wiki/Monster-Ock"],
    "Layered laboratory tunnel chase with Monster-Ock at several depth scales, tentacles, flames, collapsing geometry and exit states.",
  ),
  finalPolicy(
  ...
  finalPolicy(
    ...
    "Rassembler les preuves, stabiliser le reacteur et dejouer le plan de Burns avant la fusion.",
    "Gather evidence, stabilize the reactor and stop Burns's scheme before meltdown.",
