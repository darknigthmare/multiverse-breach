...
export const EXPANDED_UNIVERSES = [
  ...
  ...makeUniverseWave([
    ...
    { key: 'house_dead_1', universe: 'House of the Dead', mediaType: 'game', faction: 'horror', mode: 'Smash', difficulty: 'Hard', titleFr: 'House of the Dead', stage: 'Curien Mansion Outbreak', boss: 'Magician Type-0', hero: ['thomas_rogan_hotd', 'Thomas Rogan', 'marine'], allies: [['g_hotd', 'Agent G', 'tactical'], ['sophie_hotd', 'Sophie Richards', 'hacker']], monsters: ['Curien Zombie', 'Ceiling Crawler', 'Undead Dog'], bosses: ['Chariot', 'Hangedman'], gear: [['ams_pistol_mod', 'AMS Pistol Mod', 'Pistolet AMS ameliore', { atk: 9, spd: 1 }], ['red_herb_vial', 'Red Herb Vial', 'Fiole d herbe rouge', { hp: 80 }], ['research_key_card', 'Research Key Card', 'Carte-cle de recherche', { def: 6, hp: 45 }]], event: ['evt_hotd1_bullet_time', 'Bullet Time Volley', 'Salve ralentie', 'A precision volley slows time and hits all enemies with headshots.', 'Une salve de precision ralentit le temps et touche tous les ennemis en pleine tete.'], theme: 'arcade agents, Curien mansion experiments, zombies, and Tarot-coded bioweapons', motif: 'hauntedset', colors: ['#1a0d0d', '#030101', '#ff4b3e'] },
    { key: 'house_dead_2', universe: 'House of the Dead 2', mediaType: 'game', faction: 'horror', mode: 'Smash', difficulty: 'Hard', titleFr: 'House of the Dead 2', stage: 'Venice Goldman Incident', boss: 'Emperor Prototype', hero: ['james_taylor_hotd2', 'James Taylor', 'marine'], allies: [['gary_stewart_hotd2', 'Gary Stewart', 'tactical'], ['amy_crystal_hotd2', 'Amy Crystal', 'hacker']], monsters: ['Venice Zombie', 'Aquatic Mutant', 'Undead Bat'], bosses: ['Judgment (Kuarl & Zeal)', 'Tower'], gear: [['goldman_badge', 'Goldman Badge', 'Badge Goldman', { def: 7, hp: 50 }], ['ams_magnum', 'AMS Magnum', 'Magnum AMS', { atk: 11 }], ['antidote_phial', 'Antidote Phial', 'Fiole d antidote', { hp: 75, def: 3 }]], event: ['evt_hotd2_headshot_chain', 'Headshot Chain', 'Chaine de headshots', 'A rapid headshot chain deals escalating damage to all enemies.', 'Une chaine de tirs en pleine tete inflige des degats croissants a tous les ennemis.'], theme: 'Goldman outbreak, canals full of undead, arcade rescue routes, and synthetic final forms', motif: 'arcanecity', colors: ['#1b1510', '#030201', '#ff9d4a'] },
    { key: 'house_dead_3', universe: 'House of the Dead 3', mediaType: 'game', faction: 'horror', mode: 'Smash', difficulty: 'Hard', titleFr: 'House of the Dead 3', stage: 'EFI Research Facility', boss: 'Wheel of Fate', hero: ['lisa_rogan_hotd3', 'Lisa Rogan', 'slayer'], allies: [['g_hotd3', 'Agent G Veteran', 'tactical'], ['dan_taylor_hotd3', 'Dan Taylor', 'marine']], monsters: ['EFI Zombie', 'Security Bot', 'Death Screamer'], bosses: ['Death', 'Fool'], gear: [['pump_shotgun_mod', 'Pump Shotgun Mod', 'Fusil a pompe ameliore', { atk: 10, def: 3 }], ['rogan_family_crest', 'Rogan Family Crest', 'Blason de la famille Rogan', { hp: 70, def: 4 }], ['dna_sample', 'DNA Sample', 'Echantillon ADN', { atk: 7, spd: 2 }]], event: ['evt_hotd3_shotgun_blast', 'Shotgun Blast Wave', 'Onde de tir au fusil', 'A wide shotgun blast knocks back and damages all enemies in range.', 'Un tir de fusil a pompe repousse et blesse tous les ennemis a portee.'], theme: 'shotguns, abandoned facilities, post-outbreak corridors, and fate-driven experiments', motif: 'facility', colors: ['#101916', '#020403', '#5dff88'] },
  ...
  ...makeUniverseWave([
    ...
    { key: 'spider_ps1', universe: 'Spider-Man PS1', mediaType: 'game', faction: 'cyber', mode: 'Smash', difficulty: 'Medium', titleFr: 'Spider-Man PS1', stage: 'Rooftop Symbiote Chase', boss: 'Monster Ock Nexus Pursuit', hero: ['spiderman_ps1', 'Spider-Man', 'slayer'], allies: [['black_cat_ps1', 'Black Cat', 'tactical'], ['captain_stacy_ps1', 'Police Scanner', 'hacker']], monsters: ['Symbiote Thug', 'Scorpion Drone', 'Lizardman'], bosses: ['Venom', 'Carnage'], gear: [['web_cartridge', 'Web Cartridge', 'Cartouche de toile', { spd: 3, def: 1 }], ['spider_armor', 'Spider-Armor', 'Armure araignée', { def: 5 }], ['daily_bugle_press_pass', 'Daily Bugle Press Pass', 'Badge presse du Daily Bugle', { hp: 3 }]], event: ['evt_symbiote_suit_rage', 'Symbiote Suit Rage', 'Rage du costume symbiotique', 'Don the symbiote suit to massively boost attack but lose defense', 'Enfile le costume symbiotique pour augmenter massivement l\'attaque mais perdre la défense'], theme: 'PS1 rooftop swings, symbiote chases, comic panels, and polygonal superhero action', motif: 'arcanecity', colors: ['#142c59', '#03050a', '#ff3535'] },
